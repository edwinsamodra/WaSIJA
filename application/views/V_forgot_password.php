    			...
    			<div class="col-md-4 login-box z-depth-5 rounded mb-50">
    				<div class="px-4 py-4">
    					<center><a href="#AboutWaSIJA" id="btnMdlAbout" class="view zoom"><img class="front-logo" src="<?= base_url("assets/img/logo2.png") ?>"></a></center>
                            <form autocomplete="off" class="form-horizontal" action="<?= base_url('Start_With/newPassword');?>" method="post">
                                <div class="md-form">
                                ...
                                <center>
                                    ...
                                    <button class="btn btn-primary btn-sm waves-effect" disabled="true" id="btn_submit"><i class="fas fa-search mr-1"></i>&nbsp;Search</button>
                                    <button class="btn btn-dark btn-sm waves-effect" onclick="alert('Hubungi Mas Antok!')"><i class="fas fa-question mr-1"></i>&nbsp;Butuh Bantuan ?</a>
                                </center>
                            </form>
    				</div>
    			</div>
